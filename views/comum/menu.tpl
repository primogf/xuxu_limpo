                            ...
                            <li class="panel panel-default dropdown">
                                ...
                                <div id="dropdown-element" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <ul class="nav navbar-nav">
                                            <li><a href="ui-kits/theming.html">Fazendas</a>
                                            </li>
                                            <li><a href="ui-kits/grid.html">Cadastro do Animal</a>
                                            </li>
                                            <li><a href="ui-kits/button.html">Banco de Semem</a>
                                            </li>
                                            <li><a href="ui-kits/card.html">Cadastro de Consulta</a>
                                            </li>
                                            <li><a href="ui-kits/list.html">Cadastro de Nascimentos</a>
                                            </li>
                                            <li><a href="ui-kits/modal.html">Caixa</a>
                                            </li>                                            
                                        </ul>
                                    </div>
                                </div>
